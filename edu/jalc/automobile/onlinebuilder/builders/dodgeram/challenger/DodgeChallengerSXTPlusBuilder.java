...
public class DodgeChallengerSXTPlusBuilder implements DodgeRamBuilderInterface{
  ...
  private Paint paint;
   ...
   public static void main(String... args){
      Automobile auto = new DodgeChallengerSXTPlusBuilder()
         .askForPowerTrain()
   ...
   public DodgeRamBuilderInterface askForPowerTrain(){
     TerminalPrompterBuilder promptBuilder = TerminalPrompterBuilder.newBuilder();
      ...
      try{
         ...
         .build()
         .tell("Your SXT Plus Comes With " + engineAssembly);
      }catch(Exception e){}
   ...
   public DodgeRamBuilderInterface askForColorAndInterior(){
    ...
    TerminalPrompterBuilder promptBuilder = TerminalPrompterBuilder.newBuilder();
        ...
        try{
           promptBuilder.addType("Wheels & Tires")
              ...
              .build()
              .tell("Your SXT Plus Comes With " + aluminumWheel + "\nYour SXT Plus Comes With " + allSeasonPerformanceTire);
	...
	public DodgeRamBuilderInterface askForPackages(){
     ...
     try{
       promptBuilder.addType("Powertrain")
         .addOption(engineAssembly)
         .build()
         .tell("Your SXT Plus Comes With A " + engineAssembly);
     }catch(Exception e){e.printStackTrace();}
      this.engineAssembly = engineAssembly;
      return this;
   }
    ...
    return new Automobile("Dodge","Challenger","SXT Plus",this.body,this.driveline,this.engineAssembly,this.suspension);
   }
